...
This example is run on a set of ~20 Crenarchaeal Genomes and the location dirs are kept for convenience. To run on this example please copy the genomes to your own dir and *do not run this in the original folder*
...
11. KOhmms: downloaded 90419 from [link here](https://www.genome.jp/tools/kofamkoala/)
...
## Get list to link old with new contig name, test name: NIOZ136_mx_b338_temp
##################################
```bash
mkdir contig_maping
